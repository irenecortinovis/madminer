...
miner = MadMiner()
miner.load("data_ew_wphi2/setup.h5")
...
miner.run(
    ...
    temp_directory = './',
    mg_directory=mg_dir,
    mg_process_directory='./mg_processes_ew_wphi2/signal_pythia',
    proc_card_file='cards/proc_card_signal.dat',
    param_card_template_file='cards/param_card_template.dat',
    pythia8_card_file='cards/pythia8_card.dat',
    run_card_file='cards/run_card_signal_large.dat',
    log_directory='logs_ew_wphi2/signal',
...
miner.run_multiple(
    ...
    mg_directory=mg_dir,
    temp_directory = './',
    mg_process_directory='./mg_processes_ew_wphi2/signal_pythia2',
    proc_card_file='cards/proc_card_signal.dat',
    param_card_template_file='cards/param_card_template.dat',
    pythia8_card_file='cards/pythia8_card.dat',
    run_card_files=['cards/run_card_signal_small.dat'],
    log_directory='logs_ew_wphi2/signal2',
    initial_command="PYTHONPATH=/usr/lib64/python",
    python2_override=True,
)
...
delphes = DelphesReader('data_ew_wphi2/setup.h5')
...
delphes.add_sample(
    lhe_filename='mg_processes_ew_wphi2/signal_pythia/Events/run_01/unweighted_events.lhe.gz',
    hepmc_filename='mg_processes_ew_wphi2/signal_pythia/Events/run_01/tag_1_pythia8_events.hepmc.gz',
...
for i, benchmark in enumerate(additional_benchmarks):
    delphes.add_sample(
        lhe_filename='mg_processes_ew_wphi2/signal_pythia2/Events/run_0{}/unweighted_events.lhe.gz'.format(i+1),
        hepmc_filename='mg_processes_ew_wphi2/signal_pythia2/Events/run_0{}/tag_1_pythia8_events.hepmc.gz'.format(i+1),
...
delphes.run_delphes(
    ...
    log_file='logs_ew_wphi2/delphes.log',
)

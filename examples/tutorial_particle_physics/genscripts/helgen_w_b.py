...
miner.run_multiple(
    ...
    mg_directory=mg_dir,
    temp_directory = './',
    mg_process_directory='./mg_processes_hel_w_b/signal_pythia2',
    ...
    log_directory='logs_hel_w_b/signal2',
...
miner.run(
    ...
    temp_directory = './',
    mg_directory=mg_dir,
    mg_process_directory='./mg_processes_hel_w_b/signal_pythia',
    proc_card_file='cards/proc_card_signal_hel.dat',
    param_card_template_file='cards/param_card_template_hel.dat',
    pythia8_card_file='cards/pythia8_card.dat',
    run_card_file='cards/run_card_hel_large.dat',
    log_directory='logs_hel_w_b/signal',
    initial_command="PYTHONPATH=/usr/lib64/python",
    python2_override=True,
)
...
delphes = DelphesReader('data_hel_w_b/setup.h5')
...
delphes.add_sample(
    lhe_filename='mg_processes_hel_w_b/signal_pythia/Events/run_01/unweighted_events.lhe.gz',
    hepmc_filename='mg_processes_hel_w_b/signal_pythia/Events/run_01/tag_1_pythia8_events.hepmc.gz',
...
for i, benchmark in enumerate(additional_benchmarks):
    delphes.add_sample(
        lhe_filename='mg_processes_hel_w_b/signal_pythia2/Events/run_0{}/unweighted_events.lhe.gz'.format(i+1),
        hepmc_filename='mg_processes_hel_w_b/signal_pythia2/Events/run_0{}/tag_1_pythia8_events.hepmc.gz'.format(i+1),
...
delphes.run_delphes(
    ...
    log_file='logs_hel_w_b/delphes.log',
)
...
delphes.save('data_hel_w_b/delphes_data.h5')
...
combine_and_shuffle(
    ['data_hel_w_b/delphes_data.h5'],
    'data_hel_w_b/delphes_data_shuffled.h5'
)

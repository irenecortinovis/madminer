...
miner.run(
    ...
    temp_directory = './',
    mg_directory=mg_dir,
    mg_process_directory='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia',
...
miner.run_multiple(
    ...
    mg_directory=mg_dir,
    temp_directory = './',
    mg_process_directory='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia2',
    proc_card_file='cards/proc_card_signal.dat',
    param_card_template_file='cards/param_card_template.dat',
    pythia8_card_file='cards/pythia8_card.dat',
...
delphes = DelphesReader('/data_CMS/cms/cortinovis/ewdim6/data_ew_1M_az/setup.h5')

delphes.add_sample(
    lhe_filename='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia/Events/run_01/unweighted_events.lhe.gz',
    hepmc_filename='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia/Events/run_01/tag_1_pythia8_events.hepmc.gz',
...
for i, benchmark in enumerate(additional_benchmarks):
    delphes.add_sample(
        lhe_filename='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia2/Events/run_0{}/unweighted_events.lhe.gz'.format(i+1),
        hepmc_filename='/data_CMS/cms/cortinovis/ewdim6/mg_processes_ew_1M_az/signal_pythia2/Events/run_0{}/tag_1_pythia8_events.hepmc.gz'.format(i+1),
...
delphes.run_delphes(
    ...
    log_file='/data_CMS/cms/cortinovis/ewdim6/logs_ew_1M_az/delphes.log',
)

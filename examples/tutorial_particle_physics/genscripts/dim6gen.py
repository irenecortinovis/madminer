...
miner = MadMiner()
miner.load("/home/llr/cms/cortinovis/miner/madminer/examples/tutorial_particle_physics/data_dim6_3/setup.h5")
...
miner.run_multiple(
    ...
    mg_directory=mg_dir,
    temp_directory = './',
    mg_process_directory='./mg_processes_dim6_3/signal_pythia2',
    proc_card_file='cards/proc_card_wbf_signal.dat',
    param_card_template_file='cards/param_card_template_dim6.dat',
    pythia8_card_file='cards/pythia8_card.dat',
    run_card_files=['cards/run_card_wbf_signal.dat'],
    log_directory='logs_dim6_3/signal2',
...
miner.run(
    ...
    temp_directory = './',
    mg_directory=mg_dir,
    mg_process_directory='./mg_processes_dim6_3/signal_pythia',
    proc_card_file='cards/proc_card_wbf_signal.dat',
    param_card_template_file='cards/param_card_template_dim6.dat',
    pythia8_card_file='cards/pythia8_card.dat',
    run_card_file='cards/run_card_wbf_signal_large.dat',
    log_directory='logs_dim6_3/signal',
    initial_command="PYTHONPATH=/usr/lib64/python",
    python2_override=True,
)
...
delphes = DelphesReader('data_dim6_3/setup.h5')
...
delphes.add_sample(
    lhe_filename='mg_processes_dim6_3/signal_pythia/Events/run_01/unweighted_events.lhe.gz',
    hepmc_filename='mg_processes_dim6_3/signal_pythia/Events/run_01/tag_1_pythia8_events.hepmc.gz',
...
for i, benchmark in enumerate(additional_benchmarks):
    delphes.add_sample(
        lhe_filename='mg_processes_dim6_3/signal_pythia2/Events/run_0{}/unweighted_events.lhe.gz'.format(i+1),
        hepmc_filename='mg_processes_dim6_3/signal_pythia2/Events/run_0{}/tag_1_pythia8_events.hepmc.gz'.format(i+1),
...
delphes.run_delphes(
    ...
    log_file='logs_dim6_3/delphes.log',
)
